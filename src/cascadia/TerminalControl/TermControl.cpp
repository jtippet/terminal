...
namespace winrt::Microsoft::Terminal::TerminalControl::implementation
{
    ...
    bool TermControl::MoveSelectionAnchor(Settings::Direction dir, Settings::SelectionExpansionMode mode)
    {
        ...
        case Settings::SelectionExpansionMode::Viewport:
            ...
            break;
        case Settings::SelectionExpansionMode::Line:
            selectionMode = ::Microsoft::Terminal::Core::Terminal::SelectionExpansionMode::Line;
            break;
        ...
        _terminal->KeyboardSelection(selectionDir, selectionMode);
        return true;
    }
