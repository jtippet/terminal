...
namespace winrt::TerminalApp::implementation
{
    ...
    static constexpr std::string_view LineString{ "line" };
    ...
    static winrt::Microsoft::Terminal::Settings::SelectionExpansionMode ParseExpansionMode(const std::string& expansionModeString)
    {
        ...
        else if (expansionModeString == LineString)
        {
            return winrt::Microsoft::Terminal::Settings::SelectionExpansionMode::Line;
        }
    ...
    struct KeyboardSelectionArgs : public KeyboardSelectionArgsT<KeyboardSelectionArgs>
    {
        ...
        GETSET_PROPERTY(winrt::Microsoft::Terminal::Settings::Direction, Direction, winrt::Microsoft::Terminal::Settings::Direction::Left);
    ...
    public:
        bool Equals(const IActionArgs& other)
        {
            auto otherAsUs = other.try_as<KeyboardSelectionArgs>();
            if (otherAsUs)
            {
